<div class="popup-contenedor">
	...
	<div class="buildify_tm_contact_wrap sin_margen_bottom">
		<div class="get_in_touch_wrap">
			<div class="inner_wrap">
                <form class="contact_form" id="formulario-precalificate" enctype="multipart/form-data" method="post" data-route="{{ route('precalificacion') }}">
                    {{ csrf_field() }}
                    <div class="row">
                        <input id="NombreYApellido" name="NombreYApellido" type="text" placeholder="Nombre y Apellido" />
                        <div id="error_nombreyapellido" class="error"></div>
                    </div>
                    <div class="row">
					...
					<div class="row">
                        ...
                        <div id="error_empresa" class="error"></div>
                    </div>
					<div class="row">
                        <input id="CUIT" name="CUIT" type="number" placeholder="CUIT"  />
                        <div id="error_cuit" class="error"></div>
                    </div>
					<div class="row">
					...
					<div class="row">
                        ...
                        {{-- <div id="error_actividad" class="error"></div> --}}
					</div>
					...
					<div class="row margen">
						...
						<div class="row50-enviar">
								<div id="error" class="error" style="padding-bottom:5px;"></div>
								<input type="submit" id="enviar" value="Enviar"/>
								<input type="button" id="enviando" value="Enviando..." class="oculto"/>
						</div>
						
						<div class="row50-terminos">
							<label><input id="terminos" name="Acepta" type="checkbox" style="width: 12px !important; height: 12px !important;" /> Acepto Políticas de privacidad</label>
							<div id="error_terminos" class="error">
						</div>
					</div>
				</form>
			</div>
		</div>
		<div class="row100" id="legales-precalificate">
			<hr>
	...
	<span class="popup-cerrar" id="cerrar-pop" style="cursor: pointer">X</span>
</div>
</div>
